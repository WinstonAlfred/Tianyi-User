...
export default async function LoadingPage({ params }: { params: { id: string } }) {
  try {
    const detail = await getDetail(params.id);

    return (
      <div className="container mx-auto px-4 py-8">
        <LoadingTimeline loadingData={detail.Loading} shipmentId={detail.id} />
